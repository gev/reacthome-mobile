import 'package:reacthome/features/connection/connection_controller.dart';
...
import 'package:reacthome/features/connection/websocket_service.dart';
...
class ConnectionFactory {
  ...
  Future<ConnectionViewModel> makeConnectionViewModel() async =>
      ConnectionViewModel(
        eventSource: connectionEventBus.stream,
        homeConnection: HomeConnectionFactory.instance.makeHomeConnectionApi(),
