...
class DiscoveryDaemonConfirm extends StatelessWidget {
  final String id;
  const DiscoveryDaemonConfirm(this.id, {super.key});

  @override
  Widget build(BuildContext context) {
    final locale = AppLocalizations.of(context)!;
    final title = context.select<DiscoveryDaemonViewModel, String>(
